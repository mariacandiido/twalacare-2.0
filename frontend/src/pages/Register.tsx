    ...
    <div className="min-h-screen flex items-center justify-center p-6 twala-page-enter"
      ...
      <div className="w-full max-w-md rounded-2xl p-8"
        ...
        <button
          ...
          className="twala-btn-primary w-full flex items-center justify-center gap-2 mt-5"
          style={{ padding: "13px 24px", fontSize: 15 }}
        >
          Continuar como {PROFILES.find(p => p.type === selected)?.label}
...
export function Register() {
  ...
  return <ProfileSelection onSelect={(t) => { setActiveType(t); window.scrollTo(0, 0); }} />;
}
