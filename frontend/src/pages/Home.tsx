...
export function Home() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        const res = await fetch(`${API_BASE}/public/medicamentos`);
  ...
  return (
    <div className="twala-page-enter">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <img
                ...
                style={{
                  height: 420,
                  border: "2px solid rgba(199,162,82,0.25)",
                }}
              />
              {/* Badge flutuante */}
              <div
      ...
      <section className="py-14" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-10">
            ...
            <Link
              to="/farmacos"
              className="twala-link font-medium"
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(44,85,48,0.1), rgba(199,162,82,0.1))",
                    }}
                  >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  >
                    ...
                    >
                      {farmacia.provincia}, {farmacia.municipio}
                    </span>
                  </div>
      ...
      <section
        ...
        style={{
          background: `linear-gradient(135deg, ${GREEN} 0%, #3a6b40 100%)`,
        }}
      >
        {/* Decoração de fundo */}
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <span
            className="twala-seal mb-6 inline-flex"
            style={{
