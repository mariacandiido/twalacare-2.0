            ...
            <div data-field-error={errors.confirmPassword || undefined}>
              ...
              {confirmPassword && password && (
                <p className="mt-1.5 flex items-center gap-1.5"
                  style={{ fontFamily: "'Roboto',sans-serif", fontSize: 12, color: password === confirmPassword ? GREEN : RED }}>
                  <span>{password === confirmPassword ? "✓ As senhas coincidem" : "✗ As senhas não coincidem"}</span>
                </p>
              )}
            </div>
